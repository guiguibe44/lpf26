...
class GameMatchCrudController extends AbstractAppCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            NumberField::new('coteDomicile')->setLabel('Cote 1')->setNumDecimals(2)->hideOnForm(),
            NumberField::new('coteNul')->setLabel('Cote N')->setNumDecimals(2)->hideOnForm(),
            NumberField::new('coteExterieur')->setLabel('Cote 2')->setNumDecimals(2)->hideOnForm(),
