...
use App\Data\AdminCompetChecklistScenario;
use App\Service\AdminCompetChecklistProvider;
...
final class AdminCompetChecklistController extends AbstractController
{
    #[Route('/admin/checklist-compet', name: 'admin_compet_checklist', methods: ['GET'])]
    public function index(
        AdminCompetChecklistProvider $checklistProvider,
        ...
        $cronPath = $this->generateUrl('cron_test_match_step', referenceType: UrlGeneratorInterface::ABSOLUTE_PATH);

        return $this->render('admin/compet_checklist.html.twig', [
            'sections' => $sections,
            ...
            'scenario' => AdminCompetChecklistScenario::playbook($cronPath),
        ]);
    }

    #[Route('/admin/checklist-compet/note/{itemId}', name: 'admin_compet_checklist_note_save', methods: ['POST'])]
    public function saveNote(
        ...
        if (!$this->isCsrfTokenValid('admin_compet_note', $csrfToken)) {
