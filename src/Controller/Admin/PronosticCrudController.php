...
class PronosticCrudController extends AbstractAppCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            NumberField::new('points')->setLabel('Pts joueur')->setNumDecimals(0)->onlyOnIndex()->onlyOnDetail(),
            NumberField::new('pointsEquipe')->setLabel('Pts équipe')->setNumDecimals(0)->onlyOnIndex()->onlyOnDetail(),
