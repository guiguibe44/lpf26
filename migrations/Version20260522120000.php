...
final class Version20260522120000 extends AbstractMigration
{
    ...
    public function postUp(Schema $schema): void
    {
        ...
        $slides = [
            ...
            [30, 1, 'Multiplie tes points', null, 'points', '× cote', 'chart-line', '<p><strong>Score exact</strong> = 30 pts de base, <strong>bon 1/N/2</strong> = 10 pts, sinon 0. Les <strong>cotes</strong> (1, N, 2) montent quand peu de monde parie sur ce résultat — plafond ×5.</p><p>Points finaux = base × cote. Les cotes apparaissent au coup d’envoi.</p>'],
